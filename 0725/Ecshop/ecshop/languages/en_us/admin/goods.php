...
$_LANG['tip_imgSize'] = 'Single picture cannot be larger than 2m';
$_LANG['tip_param_error'] = 'Parameter error!';
$_LANG['tip_upload_component'] = 'The upload component does not support your browser!';
$_LANG['tip_upload_error'] = 'upload failed!';
$_LANG['tip_file'] = 'file:';
$_LANG['tip_errocode'] = 'error code:';
$_LANG['tip_filehaschoose'] = 'This file has already been selected!';
$_LANG['tip_fileNumer_exceedslimit'] = 'The number of uploaded files exceeds the limit!';
$_LANG['tip_fileSize_exceedslimit'] = 'File size exceeds limit!';
$_LANG['tip_allSize_exceedslimit'] = 'The total size of all files exceeds the limit!';
$_LANG['tip_fileType_error'] = 'Incorrect file type or empty file!';
$_LANG['tip_unknow_error'] = 'unknown mistake!';
$_LANG['tip_upload_completed'] = 'uploaded completed';
...
$_LANG['img_resolution_fail'] = 'Picture parsing failed.';
$_LANG['img_upload_fail'] = 'Picture upload failed.';
