...
$_LANG['stock_insufficiency'] = '非常抱歉，您選擇的商品 %s 的庫存數量只有 %d，您最多隻能購買 %d 件。';
...
$_LANG['address_amount'] = '您的收貨地址最多隻能是三個';
