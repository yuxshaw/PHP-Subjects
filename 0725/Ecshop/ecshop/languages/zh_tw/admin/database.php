...
$_LANG['notice_use_new_pre'] = '只有在恢復全部備份時纔可以選擇“是”，否則沒有備份的表將無法使用。<br />您也可以手動修改 data/config.php 中的 $prefix 變量來決定使用哪個表前綴';$_LANG['upload_and_exe'] = '上傳並執行sql文件';
...
$_LANG['not_sql_file'] = '你上傳的好象不是sql文件，如果文件確實是sql文件，請將文件擴展名改爲.sql';
...
$_LANG['js_languages']['sql_name_not_null'] = '文件名不能爲空';
$_LANG['js_languages']['vol_size_not_null'] = '請填入備份大小';

/* 數據備份 */
$_LANG['backup_title'] = '數據文件 %s 成功創建，程序將自動繼續。';
$_LANG['backup_notice'] = '如果您的瀏覽器沒有自動跳轉，請點擊這裏';
...
$_LANG['confirm_clear_demo'] = '確認要清除體驗數據嗎？';
