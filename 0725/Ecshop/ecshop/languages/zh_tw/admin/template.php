...
$_LANG['current_template'] = '當前使用的模板';
$_LANG['available_templates'] = '已安裝';
...
$_LANG['install_template_success'] = '啓用模板成功。';
...
$_LANG['template_libs']['order_query'] = '前臺訂單狀態查詢';
$_LANG['template_libs']['email_list'] = '前臺郵件訂閱';
