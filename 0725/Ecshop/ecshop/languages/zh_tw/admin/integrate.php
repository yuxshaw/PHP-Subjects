...
$_LANG['different_domain'] = '您設置的整合對象和 ECSHOP 不在同一域下。<br />您將只能共享該系統的會員數據，但無法實現同時登錄。';
...
使用方法：
         ...
         3:如果不需要整合任何用戶系統，請選擇安裝 ecshop 插件，即可卸載所有的整合插件。
                           </pre>';

/* 查看安裝日誌 */
$_LANG['lost_install_log'] = '未找到安裝日誌';
$_LANG['empty_install_log'] = '安裝日誌爲空';
...
$_LANG['lable_is_latin1'] = '是否爲latin1編碼';
...
$_LANG['check_notice'] = '本頁將檢測商城已有用戶和論壇用戶是否有重名，點擊“開始檢查前”，請爲商城重名用戶選擇一個默認處理方法';
$_LANG['default_method'] = '如果檢測出商城有重名用戶，請爲這些用戶選擇一個默認處理方法';
...
$_LANG['lable_ignore'] = '保留商城重名用戶，論壇同名用戶視爲同一用戶';
$_LANG['short_rename'] = '商城用戶改名爲';
...
/* JS語言項 */
$_LANG['js_languages']['no_host'] = '數據庫服務器主機名不能爲空。';
$_LANG['js_languages']['no_user'] = '數據庫帳號不能爲空。';
$_LANG['js_languages']['no_name'] = '數據庫名不能爲空。';
...
$_LANG['cookie_prefix_notice'] = 'UTF8版本的cookie前綴默認爲xnW_，GB2312/GBK版本的cookie前綴默認爲KD9_。';

$_LANG['js_languages']['no_method'] = '請選擇一種默認處理方法';

$_LANG['js_languages']['rate_not_null'] = '比例不能爲空';
...
$_LANG['ucenter_notice_id'] = '該值爲當前商店在 UCenter 的應用 ID，一般情況請不要改動';
...
$_LANG['user_startid_intro'] = '<p>此起始會員ID爲%s。如原 ID 爲 888 的會員將變爲 %s+888 的值。</p>';
$_LANG['uc_members_merge_way1'] = '將與UC用戶名和密碼相同的用戶強制爲同一用戶';
$_LANG['uc_members_merge_way2'] = '將與UC用戶名和密碼相同的用戶不導入UC用戶';
$_LANG['start_import'] = '開始導入';
$_LANG['import_user_success'] = '成功將會員數據導入到 UCenter';
$_LANG['uc_points'] = 'UCenter的積分兌換設置需要在UCenter管理後臺進行';
$_LANG['uc_set_credits'] = '設置積分兌換方案';
$_LANG['uc_client_not_exists'] = 'uc_client目錄不存在，請先把uc_client目錄上傳到商城根目錄下再進行整合';
$_LANG['uc_client_not_write'] = 'uc_client/data目錄不可寫，請先把uc_client/data目錄權限設置爲777';
