...
$_LANG['cfg_name']['message_check'] = '用戶留言是否需要審覈';
$_LANG['cfg_name']['logistics_trace'] = '是否開啓物流追蹤';
...
$_LANG['cfg_name']['comment_check'] = '用戶評論是否需要審覈';
...
$_LANG['cfg_name']['email_content']  = '您好！這是一封檢測郵件服務器設置的測試郵件。收到此郵件，意味着您的郵件服務器設置正確！您可以進行其它郵件發送的操作了！';
$_LANG['cfg_name']['sms'] = '短信設置';
$_LANG['cfg_name']['sms_shop_mobile'] = '商家的手機號碼';
$_LANG['cfg_name']['sms_order_placed'] = '商家接收新訂單';
$_LANG['cfg_name']['sms_order_payed'] = '消費者支付訂單時發商家';
...
$_LANG['cfg_desc']['smtp_user'] = '發送郵件所需的認證帳號，如果沒有就爲空着';
$_LANG['cfg_desc']['smtp_from_name'] = '發送的郵件來源名，默認為ECMobile';
...
$_LANG['cfg_desc']['watermark'] = '水印文件須爲gif格式纔可支持透明度設置。';
...
$_LANG['cfg_desc']['cache_time'] = '前臺頁面緩存的存活時間，以秒爲單位。';
...
$_LANG['cfg_desc']['skype'] = '如果您有多個客服的Skype號碼，請在每個號碼之間使用半角逗號（,）分隔。提示：你需要在你的Skype隱私設置中啓用狀態顯示功能';
$_LANG['cfg_desc']['attr_related_number'] = '在商品詳情頁面顯示多少個屬性關聯的商品。';
$_LANG['cfg_desc']['user_notice'] = '該信息將在用戶中心歡迎頁面顯示';
$_LANG['cfg_desc']['comment_factor'] = '選取較高的評論條件可以有效的減少垃圾評論的產生。只有用戶訂單完成後才認爲該用戶有購買行爲';
...
$_LANG['cfg_desc']['use_how_oos'] = '使用缺貨處理時前臺訂單確認頁面允許用戶選擇缺貨時處理方法。';
$_LANG['cfg_desc']['send_service_email'] = '網店信息中的客服郵件地址不爲空時，該選項有效。';
$_LANG['cfg_desc']['send_mail_on'] = '啓用該選項登錄後臺時，會自動發送郵件隊列中尚未發送的郵件';
$_LANG['cfg_desc']['sms_shop_mobile'] = '請先註冊手機短信服務再填寫手機號碼';
$_LANG['cfg_desc']['send_verify_email'] = '“是否開啓會員郵件驗證”設爲開啓時纔可使用此功能';
...
$_LANG['cfg_range']['comment_check']['0'] = '不需要審覈';
$_LANG['cfg_range']['comment_check']['1'] = '需要審覈';
$_LANG['cfg_range']['message_check']['0'] = '不需要審覈';
$_LANG['cfg_range']['message_check']['1'] = '需要審覈';
$_LANG['cfg_range']['logistics_trace']['0'] = '不需要開啓';
$_LANG['cfg_range']['logistics_trace']['1'] = '需要開啓';
$_LANG['cfg_range']['comment_factor']['0'] = '所有用戶';
$_LANG['cfg_range']['comment_factor']['1'] = '僅登錄用戶';
$_LANG['cfg_range']['comment_factor']['2'] = '有過一次以上購買行爲用戶';
...
$_LANG['rewrite_confirm_apache'] = "URL Rewrite 功能要求您的 Web Server 必須是 Apache，\\n並且起用了 rewrite 模塊。\\n同時請您確認是否已經將htaccess.txt文件重命名爲.htaccess。\\n如果服務器上還有其他的重寫規則請去掉註釋,請將RewriteBase行的註釋去掉,並將路徑設置爲服務器請求的絕對路徑";
$_LANG['rewrite_confirm_iis'] = "URL Rewrite 功能要求您的 Web Server 必須安裝IIS，\\n並且起用了 ISAPI Rewrite 模塊。\\n如果您使用的是ISAPI Rewrite商業版，請您確認是否已經將httpd.txt文件重命名爲httpd.ini。如果您使用的是ISAPI Rewrite免費版，請您確認是否已經將httpd.txt文件內的內容複製到ISAPI Rewrite安裝目錄中httpd.ini裏。";
...
$_LANG['msg_invalid_file'] = '您上傳了一個非法的文件類型。該文件名爲：%s';
...
$_LANG['cfg_name']['smtp_from_name'] = '郵件來源名';

$_LANG['mail_settings_note'] = '如果您的服務器支持 Mail 函數（具體信息請諮詢您的空間提供商）。我們建議您使用系統的 Mail 函數。<br />當您的服務器不支持 Mail 函數的時候您也可以選用 SMTP 作爲郵件服務器。';
...
$_LANG['sms_url'] = '<a href="'.$url.'" target="_blank">點此註冊手機短信服務</a>';
$_LANG['open_logistics_trace_fail'] = '啓用物流追蹤失敗';
