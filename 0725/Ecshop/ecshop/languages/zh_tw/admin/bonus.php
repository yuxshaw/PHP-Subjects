...
$_LANG['type_name_empty'] = '紅包類型名稱不能爲空！';
$_LANG['type_money_empty'] = '紅包金額不能爲空！';
$_LANG['min_amount_empty'] = '紅包類型的訂單下限不能爲空！';
$_LANG['max_amount_empty'] = '紅包類型的訂單上限不能爲空！';
$_LANG['send_count_empty'] = '紅包類型的發放數量不能爲空！';
...
$_LANG['js_languages']['type_money_isnumber'] = '類型金額必須爲數字格式!';
$_LANG['js_languages']['order_money_isnumber'] = '訂單金額必須爲數字格式!';
...
$_LANG['send_startdate_notic'] = '只有當前時間介於起始日期和截止日期之間時，此類型的紅包纔可以發放';
$_LANG['use_startdate_notic'] = '只有當前時間介於起始日期和截止日期之間時，此類型的紅包纔可以使用';
