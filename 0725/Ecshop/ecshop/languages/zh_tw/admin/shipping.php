...
/* 提示信息 */
$_LANG['no_shipping_name'] = '對不起，配送方式名稱不能爲空。';
$_LANG['no_shipping_desc'] = '對不起，配送方式描述內容不能爲空。';
$_LANG['repeat_shipping_name'] = '對不起，已經存在一個同名的配送方式。';
$_LANG['uninstall_success'] = '配送方式 %s 已經成功卸載。';
$_LANG['add_shipping_area'] = '爲該配送方式新建配送區域';
$_LANG['no_shipping_insure'] = '對不起，保價費用不能爲空，不想使用請將其設置爲0';
