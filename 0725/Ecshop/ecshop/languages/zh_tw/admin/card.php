...
/*幫助信息*/
$_LANG['notice_cardfee'] = '使用這個賀卡所需要支付的費用，免費時設置爲0';
$_LANG['notice_cardfreemoney'] = '當用戶消費金額超過這個值時，將免費使用這個賀卡<br />設置爲0表明必須支付賀卡費用';
...
$_LANG['js_languages']['cardfee_un_num'] = '賀卡費用爲空或不是數字';
$_LANG['js_languages']['cardmoney_un_num'] = '賀卡免費額度爲空或不是數字';
