...
$_LANG['notice_price'] = '獲獎者出價高於這個價格，則以這個價格購買該商品。爲0時按用戶出價購買商品';
...
$_LANG['js_languages']['invalid_min_price'] = '價格下限爲空或不是數字';
$_LANG['js_languages']['invalid_max_price'] = '最多需支付的價格爲空或不是數字';
$_LANG['js_languages']['invalid_integral'] = '消耗積分爲空或不是整數';
