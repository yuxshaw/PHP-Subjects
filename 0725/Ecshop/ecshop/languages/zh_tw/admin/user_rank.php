...
$_LANG['notice_special'] = '特殊會員組的會員不會隨着積分的變化而變化。';
$_LANG['add_continue'] = '繼續添加會員等級';
$_LANG['back_list'] = '返回會員等級列表';
$_LANG['show_price_short'] = '顯示價格';
$_LANG['notice_discount'] = '請填寫爲0-100的整數,如填入80，表示初始折扣率爲8折';

$_LANG['rank_name_exists'] = '會員等級名 %s 已經存在。';
$_LANG['add_rank_success'] = '會員等級已經添加成功。';
$_LANG['integral_min_exists'] = '已經存在一個等級積分下限爲 %d 的會員等級';
$_LANG['integral_max_exists'] = '已經存在一個等級積分上限爲 %d 的會員等級';
