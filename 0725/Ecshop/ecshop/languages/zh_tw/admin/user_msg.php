...
$_LANG['have_reply_content'] = '提示: 此條留言已有回覆, 如果繼續回覆將更新原來回復的內容!';

$_LANG['edit_reply'] = '修改回覆';
...
/* js */
$_LANG['js_languages']['no_content'] = '內容不能爲空';
$_LANG['js_languages']['no_reply_content'] = '回覆內容不能爲空';
$_LANG['js_languages']['no_title'] = '主題不能爲空';
