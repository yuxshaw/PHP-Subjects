...
$_LANG['title_upload_notice'] = '上傳該廣告的圖片文件,或者你也可以指定一個遠程URL地址爲廣告的圖片';
...
/* JS 語言項 */
$_LANG['js_languages']['setupConfirm'] = '啓用新的Flash樣式將覆蓋原來的樣式。\n您確定要啓用選定的樣式嗎？';
?>