...
$_LANG['generate_success'] = '站點地圖已經生成到相應目錄下。<br />地址爲：%s';
$_LANG['generate_failed'] = '生成站點地圖失敗，請檢查 站點根目錄、/data/ 目錄是否允許寫入.';
$_LANG['sitemaps_note'] = 'Sitemaps 服務旨在使用 Feed 文件 sitemap.xml 通知 Google、Yahoo! 以及 Microsoft 等 Crawler(爬蟲)網站上哪些文件需要索引、這些文件的最後修訂時間、更改頻度、文件位置、相對優先索引權，這些信息將幫助他們建立索引範圍和索引的行爲習慣。詳細信息請查看 <a href="http://www.sitemaps.org/" target="_blank">sitemaps.org</a> 網站上的說明。';
?>