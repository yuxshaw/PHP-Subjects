...
$_LANG['batch_best_confirm'] = '您確實要把選中的商品設爲精品嗎？';
$_LANG['batch_not_best_confirm'] = '您確實要把選中的商品取消精品嗎？';
$_LANG['batch_new_confirm'] = '您確實要把選中的商品設爲新品嗎？';
$_LANG['batch_not_new_confirm'] = '您確實要把選中的商品取消新品嗎？';
$_LANG['batch_hot_confirm'] = '您確實要把選中的商品設爲熱銷嗎？';
...
$_LANG['tip_imgSize'] = '單張圖片不能大於2m';
$_LANG['tip_param_error'] = '參數錯誤!';
$_LANG['tip_upload_component'] = '上傳組件不支持您的瀏覽器!';
$_LANG['tip_upload_error'] = '上傳失敗!';
$_LANG['tip_file'] = '文件:';
$_LANG['tip_errocode'] = '錯誤碼:';
$_LANG['tip_filehaschoose'] = '該文件已經被選擇了!';
$_LANG['tip_fileNumer_exceedslimit'] = '上傳文件數量超過限制!';
$_LANG['tip_fileSize_exceedslimit'] = '文件大小超過限制!';
$_LANG['tip_allSize_exceedslimit'] = '所有文件總大小超過限制!';
$_LANG['tip_fileType_error'] = '文件類型不正確或者是空文件!';
$_LANG['tip_unknow_error'] = '未知錯誤!';
$_LANG['tip_upload_completed'] = '上傳完成';
$_LANG['Preview'] = '預覽';
...
$_LANG['lab_is_alone_sale'] = '能作爲普通商品銷售：';
$_LANG['lab_is_free_shipping'] = '是否爲免運費商品';
...
$_LANG['notice_storage'] = '庫存在商品爲虛貨或商品存在貨品時爲不可編輯狀態，庫存數值取決於其虛貨數量或貨品數量';
$_LANG['notice_keywords'] = '用空格分隔';
$_LANG['notice_user_price'] = '會員價格爲-1時表示會員價格按會員等級折扣率計算。你也可以爲每個等級指定一個固定價格';
$_LANG['notice_goods_type'] = '請選擇商品的所屬類型，進而完善此商品的屬性';

$_LANG['on_sale_desc'] = '打勾表示允許銷售，否則不允許銷售。';
$_LANG['alone_sale'] = '打勾表示能作爲普通商品銷售，否則只能作爲配件或贈品銷售。';
...
$_LANG['img_resolution_fail'] = '圖片解析失敗。';
...
$_LANG['js_languages']['goods_name_not_null'] = '商品名稱不能爲空。';
$_LANG['js_languages']['goods_cat_not_null'] = '商品分類必須選擇。';
$_LANG['js_languages']['category_cat_not_null'] = '分類名稱不能爲空';
$_LANG['js_languages']['brand_cat_not_null'] = '品牌名稱不能爲空';
$_LANG['js_languages']['goods_cat_not_leaf'] = '您選擇的商品分類不是底級分類，請選擇底級分類。';
$_LANG['js_languages']['shop_price_not_null'] = '本店售價不能爲空。';
...
$_LANG['js_languages']['spec_value_not_null'] = '規格不能爲空';
...
$_LANG['js_languages']['promote_start_not_null'] = '促銷開始時間不能爲空';
$_LANG['js_languages']['promote_end_not_null'] = '促銷結束時間不能爲空';
...
$_LANG['not_exist_goods_attr'] = '此商品不存在規格，請爲其添加規格';
$_LANG['goods_sn_exists'] = '您輸入的貨號已存在，請換一個';
?>