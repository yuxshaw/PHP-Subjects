...
$_LANG['notice_edit'] = '會員價格爲-1表示會員價格將根據會員等級折扣比例計算';
...
$_LANG['use_help'] = '使用說明：' .
        '<ol>' .
          '<li>根據使用習慣，下載相應語言的csv文件，例如中國內地用戶下載簡體中文語言的文件，港臺用戶下載繁體語言的文件；</li>' .
          '<li>填寫csv文件，可以使用excel或文本編輯器打開csv文件；<br />' .
              '碰到“是否精品”之類，填寫數字0或者1，0代表“否”，1代表“是”；<br />' .
              '商品圖片和商品縮略圖請填寫帶路徑的圖片文件名，其中路徑是相對於 [根目錄]/images/ 的路徑，例如圖片路徑爲[根目錄]/images/200610/abc.jpg，只要填寫 200610/abc.jpg 即可；<br />' .
               '<font style="color:#FE596A;">如果是淘寶助理格式請確保cvs編碼爲在網站的編碼，如編碼不正確，可以用編輯軟件轉換編碼。</font></li>' .
...
$_LANG['upload_goods']['is_alone_sale'] = '能否作爲普通商品銷售';
