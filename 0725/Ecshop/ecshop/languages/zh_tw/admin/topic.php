...
$_LANG['tips_width_height'] = '此模板的圖片標準寬度爲：%s 標準高度爲：%s';
$_LANG['tips_upload_notice'] = '上傳該廣告的圖片文件,或者你也可以指定一個遠程URL地址爲廣告的圖片';
$_LANG['tips_title_width_height'] = '此模板的圖片標準寬度爲：%s 標準高度爲：%s';
