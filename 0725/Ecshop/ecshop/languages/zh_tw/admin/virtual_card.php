...
$_LANG['js_languages']['no_card_sn'] = '卡片序號和卡片密碼不能都爲空。';
$_LANG['js_languages']['separator_not_null'] = '分隔符號不能爲空。';
$_LANG['js_languages']['uploadfile_not_null'] = '請選擇要上傳的文件。';

$_LANG['use_help'] = '使用說明：' .
        '<ol>' .
          '<li>上傳文件應爲CSV文件<br />' .
              'CSV文件第一列爲卡片序號；第二列爲卡片密碼；第三列爲使用截至日期。<br />'.
              '(用EXCEL創建csv文件方法：在EXCEL中按卡號、卡片密碼、截至日期的順序填寫數據，完成後直接保存爲csv文件即可)'.
          '<li>密碼，和截至日期可以爲空，截至日期格式爲2006-11-6或2006/11/6'.
