...
$_LANG['dir_notes'] = '請注意原商城的根目錄路徑請使用相對於admin目錄的路徑。<br />例如：原商城的目錄在根目錄下的shop，而ecshop放在根目錄下，則該路徑爲 ../shop';
...
$_LANG['js_languages']['host_not_null'] = '主機名稱或地址不能爲空';
$_LANG['js_languages']['db_not_null'] = '數據庫名稱不能爲空';
$_LANG['js_languages']['user_not_null'] = '登錄帳號不能爲空';
$_LANG['js_languages']['path_not_null'] = '原商城根目錄不能爲空';
?>