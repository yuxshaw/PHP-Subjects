<?php
    ...
    if (isset($_GET['edit'])){
        ...
        $sql = "SELECT * FROM wd_article_cate WHERE $condition";
    ...
    if (isset($_POST['commit'])){
        ...
        $data = array(
            'artcate_name' => $_POST['cate_name'],
            'artcate_time' => time()
        );
        $condition = "artcate_id = $cate_id";
        // 修改
        $res = update('wd_article_cate',$data,$condition);
        if ($res){
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-lg-11 center-column">
                <form action="artcate_edit.php" method="post" class="cmxform">
                    <div class="panel">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group"><span class="input-group-addon">分类名称</span>
                                        <input type="text" name="cate_name" value="<?php echo $cate_info['artcate_name'];?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
