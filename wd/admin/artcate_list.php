<?php
    ...
    // 查询留言总数
    $count_sql = "SELECT COUNT(artcate_id) AS count FROM wd_article_cate";
    $count = get_one($count_sql);
    $count = $count['count'];

    // 查询所有分类
    $sql = "SELECT * FROM wd_article_cate LIMIT $n,$limit";
    $artcate = get_all($sql);
    ...
    if (isset($_GET['del'])){
        ...
        $res = del('wd_article_cate',$condition);
        if ($res){
    ...
    if (isset($_POST['delall'])){
        ...
        $del_res = del('wd_article_cate',$condition);
        if ($del_res){
            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <a href="artcate_add.php" class="btn btn-info btn-gradient pull-right"><span
